    ...
    <div class="group">
        <div class="group-2">
            ...
            <a class="div-4-link" href="{{ $site['whatsapp_url'] ?? '#' }}" target="_blank" rel="noopener">
                <p class="div-4">
                    <span class="text-wrapper-12">{{ $site['whatsapp_line1'] ?? 'للإنضمـ' }}</span><span class="text-wrapper-13">ـــ</span><span class="text-wrapper-12">  <br />{{ $site['whatsapp_line2'] ?? ' مجموعة واتساب' }}</span>
                </p>
            </a>
